...
compatibility: Requires task management capability (create/update tasks with status transitions: in_progress/completed), semantic-committing skill, and codex-review skill (note: transitive dependencies apply—see compatibility of semantic-committing and codex-review for their own requirements; git is a transitive dependency via semantic-committing, not a direct dependency of this skill)
---
...
4. semantic-committingスキルを実行してコミット作成（Claude Codeでは `Skill(syou6162-agent-skills:semantic-committing)`）
